        ...
        <div className='absolute top-0 left-0 right-0 flex flex-col justify-between bg-overlay/65 text-white h-full w-full'>
          ...
          <div className='md:py-24 py-12 px-6 md:px-16 w-full'>
            <div className='flex flex-col gap-y-1 items-start justify-center text-left h-full'>
              <h1 className='text-3xl md:text-5xl font-bold'>Our Beliefs</h1>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className='flex flex-col w-full items-center justify-center'>
        <div className='flex flex-col h-full basis-4/6'>
          ...
          <div className='flex flex-col text-left mx-80 gap-5 text-lg dark:text-neutral-300'>
            ...
            <p>
              There is one God (Deut. 6:4/Mark 12:29), besides Him there is no
              other (2 Sam 7:22). He is eternal (1 Tim 1:17) and His life is
              expressed in three equal, unified persons: Father, Son, and Holy
              Spirit (Matt. 28:19).
            </p>
            <p>
              Jesus is God in the flesh (John 1:1-2, 14/Col. 1:15-22/Col. 2:9).
              He lived a perfect, sinless life (Heb 4:15) and sacrified that
              life on the Cross that we might live free (John 8:36) and forgiven
              (Rom 8:1/John 10:10).
            </p>
            <p>
              It is by grace meaning an unmerited gift, that we are saved
              through faith in Jesus Christ (Acts 4:12/Eph 2:8,9). And with
              salvation comes a new life (2 Cor 5:17), a new heart (Ezek. 36:36,
              37) and a new mind (Rom. 12:1, 2/1 Cor 2:16).
            </p>
            <p>
              The greatest thing in the Kingdom of our Lord and Savior is
              relationship, first with God and then with one another (Matt.
              22:36-40). The Church is the Body of Christ (1 Cor. 12:27) where
              we learn how to live out the love of God (Rom. 12:9-10) and extend
              it to the world (Matt. 28:18-20).
            </p>
          </div>
        </div>
      </section>
